...
const CATEGORY_RULES: { category: string; pattern: RegExp }[] = [
  { category: '肉', pattern: /肉|豚|牛|鶏|ミンチ|ひき肉|挽肉|ベーコン|ハム|ソーセージ|ウインナー|つくね|つみれ|サラダチキン/ },
  ...
  { category: '乳製品・卵', pattern: /卵|たまご|玉子|牛乳|ヨーグルト|チーズ|バター|生クリーム|ホイップクリーム|豆腐|納豆|油揚げ|厚揚げ|豆乳/ },
  { category: '穀物・パン', pattern: /ごはん|ご飯|米|パン|うどん|そば|パスタ|スパゲティ|春雨|小麦粉|薄力粉|強力粉|片栗粉|ごま|胡麻|もち|餅|そうめん|素麺|中華麺|中華そば|ラーメン/ },
  { category: '調味料', pattern: /塩|しお|砂糖|さとう|酢|醤油|しょうゆ|味噌|みそ|みりん|酒|だし|コンソメ|スープの素|ガラスープ|油|マヨネーズ|ケチャップ|ソース|ぽん酢|ポン酢|はちみつ|蜂蜜|わさび|山葵|こしょう|コショウ|胡椒|ジャム|スプレッド|カレールー|カレールウ|豆板醤|カレー粉/ },
  { category: '豆類', pattern: /豆(?!腐|乳|板醤)|えだまめ|枝豆|もやし|アーモンド|くるみ|カシューナッツ|ピーナッツ|落花生|ナッツ/ },
  ...
  { category: '野菜', pattern: /たまねぎ|玉ねぎ|にんじん|人参|じゃがいも|トマト|きゅうり|キャベツ|だいこん|大根|なす|ナス|ピーマン|パプリカ|ブロッコリー|ほうれん|とうもろこし|コーン|ねぎ|ネギ|にんにく|ニンニク|しょうが|生姜|しいたけ|椎茸|えのき|しめじ|エリンギ|舞茸|まいたけ|きのこ|こんにゃく|しらたき|たけのこ|筍|ごぼう|牛蒡|山芋|長芋|れんこん|蓮根|アボカド|アスパラ|かぼちゃ|カボチャ|オクラ|しそ|大葉|唐辛子|白菜|ズッキーニ|かぶ|カブ|さつまいも|レタス|セロリ|ゴーヤ|水菜|小松菜|キムチ|パセリ|バジル|パクチー|コリアンダー|ローズマリー/ },
];
