...
export const CATEGORY_RULES: { category: string; pattern: RegExp }[] = [
  { category: '肉', pattern: /肉|豚|牛|鶏|ミンチ|ひき肉|挽肉|ベーコン|ハム|ソーセージ|ウインナー|つくね|つみれ|サラダチキン|マトン|七面鳥|ターキー|プラントベースミート|ささみ|コンビーフ|ハラミ|ジャーキー|サラミ|パストラミ|チョリソー|プルドポーク|スペアリブ|レバー|砂肝|ホルモン/ },
  ...
  { category: '穀物・パン', pattern: /ごはん|ご飯|米|パン|うどん|そば|パスタ|マカロニ|スパゲティ|春雨|小麦粉|薄力粉|強力粉|片栗粉|ごま|胡麻|もち|餅|求肥|ぎゅうひ|そうめん|素麺|中華麺|中華そば|ラーメン|キヌア|キノア|ファッロ|テフ|クスクス|ブルグア|ブルグル|ポレンタ|ライ麦|トルティーヤ|ピタパン|ナン(?!プラー)|ドライイースト|イースト|ライスペーパー|オートミール|シリアル|白玉粉|上新粉|ちくわぶ/ },
  { category: '調味料', pattern: /塩|しお|砂糖|さとう|酢|醤油|しょうゆ|ナンプラー|味噌|みそ|みりん|酒|だし|コンソメ|スープの素|ガラスープ|油|マヨネーズ|ケチャップ|ソース|ドレッシング|ぽん酢|ポン酢|はちみつ|蜂蜜|わさび|山葵|こしょう|コショウ|胡椒|ジャム|スプレッド|カレールー|カレールウ|豆板醤|ハリッサ|コチュジャン|カレー粉|ガラムマサラ|ケイジャンスパイス|チリパウダー|フムス|タヒニ|サルサ|スリラチャ|ペスト|タイカレーペースト|クミン|ターメリック|サフラン|シナモン|バニラ/ },
