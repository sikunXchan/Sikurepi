...
const CATEGORY_RULES: { category: string; pattern: RegExp }[] = [
  ...
  { category: '果物', pattern: /りんご|リンゴ|林檎|バナナ|レモン|オレンジ|みかん|いちご|イチゴ|苺|ぶどう|ブドウ|梨|なし|柿|かき|桃|もも|メロン|スイカ|すいか|キウイ|パイナップル|マンゴー|グレープフルーツ|レーズン|ゆず|ユズ|柚子|梅|うめ|ライチ|レイシ|茘枝|ラズベリー|木いちご|パパイヤ|パパイア|すもも|スモモ|李|プラム/ },
