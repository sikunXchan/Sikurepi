...
export const CATEGORY_RULES: { category: string; pattern: RegExp }[] = [
  ...
  { category: '穀物・パン', pattern: /ごはん|ご飯|米|パン|うどん|そば|パスタ|マカロニ|スパゲティ|春雨|小麦粉|薄力粉|強力粉|片栗粉|ごま|胡麻|もち|餅|求肥|ぎゅうひ|そうめん|素麺|中華麺|中華そば|ラーメン|キヌア|キノア|ファッロ|テフ|クスクス|ブルグア|ブルグル|ポレンタ|ライ麦|トルティーヤ|ピタパン|ナン(?!プラー)|ドライイースト|イースト|ライスペーパー|オートミール|シリアル|白玉粉|上新粉|ちくわぶ|ライスヌードル|フォー|ビーフン/ },
