...
export const CATEGORY_RULES: { category: string; pattern: RegExp }[] = [
  ...
  // (後続の「調味料」カテゴリの判定に譲る)
  { category: '穀物・パン', pattern: /ごはん|ご飯|米(?!油|酢|麹|こうじ)|パン|うどん|そば|パスタ|マカロニ|スパゲティ|春雨|小麦粉|薄力粉|強力粉|片栗粉|ごま|胡麻|もち|餅|求肥|ぎゅうひ|そうめん|素麺|中華麺|中華そば|ラーメン|キヌア|キノア|ファッロ|テフ|クスクス|ブルグア|ブルグル|ポレンタ|ライ麦|トルティーヤ|ピタパン|ナン(?!プラー)|ドライイースト|イースト|ライスペーパー|オートミール|シリアル|白玉粉|上新粉|ちくわぶ|ライスヌードル|フォー|ビーフン/ },
  ...
  { category: '果物', pattern: /りんご|リンゴ|林檎|バナナ|プランテン|プランテーン|レモン(?!グラス)|オレンジ|みかん|デコポン|キンカン|金柑|いちご|イチゴ|苺|ぶどう|ブドウ|シャインマスカット|巨峰|デラウェア|梨|なし|柿|かき|桃|もも|アプリコット|あんず|杏|メロン|スイカ|すいか|キウイ|パイナップル|パイン|マンゴー|グレープフルーツ|ポメロ|レーズン|ゆず|ユズ|柚子|梅|うめ|ライチ|レイシ|茘枝|ロンガン|リュウガン|龍眼|ラズベリー|木いちご|パパイヤ|パパイア|すもも|スモモ|李|プラム|デーツ|ナツメヤシ/ },
